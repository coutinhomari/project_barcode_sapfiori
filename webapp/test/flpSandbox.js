		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ConsultaProdutosprojetocodigobarras-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ConsultaProdutosprojetocodigobarras-display": {
								"semanticObject": "ConsultaProdutosprojetocodigobarras",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Consulta.Produtos.projetocodigobarras",
									"url": sap.ui.require.toUrl("Consulta/Produtos/projetocodigobarras")
								}
							}
						}
					}
